#ifndef _BEMF_MB_OBSV_
#define _BEMF_MB_OBSV_

#include <math.h>
#include <math_f.h>

#define BEMF_OBSERVER_UPDATE_TH 0.4
#define BEMF_OBSERVER_UPDATE_HY 0.1
#define	DELAYED_ROTOR_FLUX


typedef struct bemf_mb_obsv_s {
...
#define BEMF_MB_OBSV bemf_mb_obsv_t

void bemf_mb_obsv_init(volatile BEMF_MB_OBSV *f, volatile float bemf_obsv_fb_p_1, volatile float bemf_obsv_p_1, volatile float bemf_obsv_fb_p_2, volatile float bemf_obsv_p_2, 
...
void bemf_mb_obsv_ts(volatile BEMF_MB_OBSV *f, volatile float ts);

void bemf_mb_obsv_reset(volatile BEMF_MB_OBSV *f);

void bemf_mb_obsv_update(volatile BEMF_MB_OBSV *f,volatile float bemf_obsv_fb_p_1, volatile float bemf_obsv_p_1, volatile float bemf_obsv_fb_p_2, volatile float bemf_obsv_p_2);

float bemf_mb_obsv_process(volatile BEMF_MB_OBSV *f, volatile float u_alpha, volatile float u_beta, volatile float i_alpha, 
	volatile float i_beta, volatile float u_dc);

void obsv_omega_flt_init(volatile BEMF_MB_OBSV *f);
