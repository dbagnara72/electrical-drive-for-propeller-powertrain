...
void bemf_obsv_init(volatile BEMF_OBSV *f, volatile float bemf_obsv_fb_p, volatile float bemf_obsv_p,
...
void bemf_obsvu_update(volatile BEMF_OBSV *f,volatile float bemf_obsv_fb_p, volatile float bemf_obsv_p);
